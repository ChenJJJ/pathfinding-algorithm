...
{
	public:
		cpd_heuristic(unsigned int mapwidth, unsigned int mapheight, unsigned int width, unsigned int height) 
	    	: mapwidth_(mapwidth), mapheight_(mapheight), width_(width), height_(height) { }
		~cpd_heuristic() { }
